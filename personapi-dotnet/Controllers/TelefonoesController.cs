...
namespace personapi_dotnet.Controllers
{
    public class TelefonoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Num,Operador,Dueno")] Telefono telefono)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Num,Operador,Dueno")] Telefono telefono)
        {
            if (id != telefono.Num)
            {
                return NotFound();
